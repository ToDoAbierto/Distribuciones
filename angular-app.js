...
angular.module('app').constant('MONGOLAB_CONFIG', {
  baseUrl: '/databases/',
  dbName: 'proyectosabiertos'
});

//TODO: move those messages to a separate module
angular.module('app').constant('I18N.MESSAGES', {
  'errors.route.changeError':'Route change error',
  'crud.user.save.success':"Se ha guardado correctamente una cuenta con Id: '{{id}}'.",
  'crud.user.remove.success':"Se ha borrado correctamente una cuenta con Id: '{{id}}'.",
  'crud.user.remove.error':"Ha ocurrido algún error al borrar la cuenta con Id: '{{id}}'.",
  'crud.user.save.error':"Algo ha salido mal al guardar la cuenta...",
  'crud.project.save.success':"Se ha guardado correctamente una proyecto con Id: '{{id}}'.",
  'crud.project.remove.success':"Se ha borrado correctamente una proyecto con Id: '{{id}}'.",
  'crud.project.save.error':"Algo ha salido mal al guardar el proyecto...",
  'login.reason.notAuthorized':"No tienes los permisos de acceso necesarios. ¿Quieres iniciar sesión como otra persona?",
  'login.reason.notAuthenticated':"Debes estar registrado para acceder a esta parte de la aplicación.",
  'login.error.invalidCredentials': "Error de inicio de sesion. Por favor, comprueba tus credenciales y vuelve a intentarlo..",
  'login.error.serverError': "Hubo un problema con la autenticación: {{exception}}."
});
...
.directive('crudButtons', function () {
  return {
    ...
    template:
      '<div>' +
      '  <button type="button" class="btn btn-primary save" ng-click="save()">Guardar</button>' +
      '  <button type="button" class="btn btn-warning revert" ng-click="revertChanges()">Revertir cambios</button>'+
      '  <button type="button" class="btn btn-danger remove" ng-click="remove()" ng-show="canRemove()">Eliminar</button>'+
      '</div>'
  };
});
